...
{
	setWindowIcon(QIcon(":/lc_lib/resources/icon64.png"));
...
void lcMainWindow::CreateActions()
{
	...
	mActions[LC_FILE_NEW]->setIcon(QIcon(":/lc_lib/resources/file_new.png"));
	mActions[LC_FILE_OPEN]->setIcon(QIcon(":/lc_lib/resources/file_open.png"));
	mActions[LC_FILE_SAVE]->setIcon(QIcon(":/lc_lib/resources/file_save.png"));
	mActions[LC_FILE_SAVE_IMAGE]->setIcon(QIcon(":/lc_lib/resources/file_picture.png"));
	mActions[LC_FILE_PRINT]->setIcon(QIcon(":/lc_lib/resources/file_print.png"));
	mActions[LC_FILE_PRINT_PREVIEW]->setIcon(QIcon(":/lc_lib/resources/file_print_preview.png"));
	mActions[LC_EDIT_UNDO]->setIcon(QIcon(":/lc_lib/resources/edit_undo.png"));
	mActions[LC_EDIT_REDO]->setIcon(QIcon(":/lc_lib/resources/edit_redo.png"));
	mActions[LC_EDIT_CUT]->setIcon(QIcon(":/lc_lib/resources/edit_cut.png"));
	mActions[LC_EDIT_COPY]->setIcon(QIcon(":/lc_lib/resources/edit_copy.png"));
	mActions[LC_EDIT_PASTE]->setIcon(QIcon(":/lc_lib/resources/edit_paste.png"));
	mActions[LC_EDIT_ACTION_INSERT]->setIcon(QIcon(":/lc_lib/resources/action_insert.png"));
	mActions[LC_EDIT_ACTION_LIGHT]->setIcon(QIcon(":/lc_lib/resources/action_light.png"));
	mActions[LC_EDIT_ACTION_SPOTLIGHT]->setIcon(QIcon(":/lc_lib/resources/action_spotlight.png"));
	mActions[LC_EDIT_ACTION_CAMERA]->setIcon(QIcon(":/lc_lib/resources/action_camera.png"));
	mActions[LC_EDIT_ACTION_SELECT]->setIcon(QIcon(":/lc_lib/resources/action_select.png"));
	mActions[LC_EDIT_ACTION_MOVE]->setIcon(QIcon(":/lc_lib/resources/action_move.png"));
	mActions[LC_EDIT_ACTION_ROTATE]->setIcon(QIcon(":/lc_lib/resources/action_rotate.png"));
	mActions[LC_EDIT_ACTION_DELETE]->setIcon(QIcon(":/lc_lib/resources/action_delete.png"));
	mActions[LC_EDIT_ACTION_PAINT]->setIcon(QIcon(":/lc_lib/resources/action_paint.png"));
	mActions[LC_EDIT_ACTION_ZOOM]->setIcon(QIcon(":/lc_lib/resources/action_zoom.png"));
	mActions[LC_EDIT_ACTION_PAN]->setIcon(QIcon(":/lc_lib/resources/action_pan.png"));
	mActions[LC_EDIT_ACTION_ROTATE_VIEW]->setIcon(QIcon(":/lc_lib/resources/action_rotate_view.png"));
	mActions[LC_EDIT_ACTION_ROLL]->setIcon(QIcon(":/lc_lib/resources/action_roll.png"));
	mActions[LC_EDIT_ACTION_ZOOM_REGION]->setIcon(QIcon(":/lc_lib/resources/action_zoom_region.png"));
	mActions[LC_EDIT_TRANSFORM_RELATIVE]->setIcon(QIcon(":/lc_lib/resources/edit_transform_relative.png"));
	mActions[LC_PIECE_SHOW_EARLIER]->setIcon(QIcon(":/lc_lib/resources/piece_show_earlier.png"));
	mActions[LC_PIECE_SHOW_LATER]->setIcon(QIcon(":/lc_lib/resources/piece_show_later.png"));
	mActions[LC_VIEW_SPLIT_HORIZONTAL]->setIcon(QIcon(":/lc_lib/resources/view_split_horizontal.png"));
	mActions[LC_VIEW_SPLIT_VERTICAL]->setIcon(QIcon(":/lc_lib/resources/view_split_vertical.png"));
	mActions[LC_VIEW_ZOOM_IN]->setIcon(QIcon(":/lc_lib/resources/view_zoomin.png"));
	mActions[LC_VIEW_ZOOM_OUT]->setIcon(QIcon(":/lc_lib/resources/view_zoomout.png"));
	mActions[LC_VIEW_ZOOM_EXTENTS]->setIcon(QIcon(":/lc_lib/resources/view_zoomextents.png"));
	mActions[LC_VIEW_TIME_FIRST]->setIcon(QIcon(":/lc_lib/resources/time_first.png"));
	mActions[LC_VIEW_TIME_PREVIOUS]->setIcon(QIcon(":/lc_lib/resources/time_previous.png"));
	mActions[LC_VIEW_TIME_NEXT]->setIcon(QIcon(":/lc_lib/resources/time_next.png"));
	mActions[LC_VIEW_TIME_LAST]->setIcon(QIcon(":/lc_lib/resources/time_last.png"));
	mActions[LC_VIEW_TIME_ADD_KEYS]->setIcon(QIcon(":/lc_lib/resources/time_add_keys.png"));
	mActions[LC_HELP_HOMEPAGE]->setIcon(QIcon(":/lc_lib/resources/help_homepage.png"));
	mActions[LC_HELP_EMAIL]->setIcon(QIcon(":/lc_lib/resources/help_email.png"));
...
void lcMainWindow::SetTransformType(lcTransformType TransformType)
{
	...
	{
		":/lc_lib/resources/edit_transform_absolute_translation.png",
		":/lc_lib/resources/edit_transform_relative_translation.png",
		":/lc_lib/resources/edit_transform_absolute_rotation.png",
		":/lc_lib/resources/edit_transform_relative_rotation.png"
	};
