...
lcCommand gCommands[LC_NUM_COMMANDS] =
{
	...
	// LC_EDIT_UNDO
	{
        ...
        QT_TRANSLATE_NOOP("Shortcut", "Ctrl+Shift+Y")                     /*** LPub3D Mod - LPub3D Menu conflict ***/
	},
	// LC_EDIT_REDO
	{
        ...
        QT_TRANSLATE_NOOP("Shortcut", "Ctrl+Shift+Z")                     /*** LPub3D Mod - LPub3D Menu conflict ***/
	},
	// LC_EDIT_CUT
	{
	...
	// LC_EDIT_FIND
	{
        ...
        QT_TRANSLATE_NOOP("Status", "Find object - Ctrl+Shift+F"),         /*** LPub3D Mod - LPub3D Menu update ***/
...
/*** LPub3D Mod - coord format commands ***/
    ...
    // LC_EDIT_ROTATESTEP_COORD_FORMAT_LEOCAD
    {
         ...
         QT_TRANSLATE_NOOP("Status", "Enter rotation using 3DViewer XYZ coordinates. It will be translated to LDraw format - Shift+D"),
...
/*** LPub3D Mod - rotatestep command ***/
    ...
    // LC_EDIT_ACTION_CLEAR_TRANSFORM
    {
        ...
        QT_TRANSLATE_NOOP("Shortcut", "Shift+C")
    },
/*** LPub3D Mod end ***/
	// LC_EDIT_CANCEL
	{
