...
lcViewSphere::lcViewSphere(lcView* View, bool SubstituteView)
	: mView(View), mIsSubstituteView(SubstituteView)
{
/*** LPub3D Mod end ***/
	UpdateSettings();
}
...
/*** LPub3D Mod - preview widget for LPub3D ***/
		if (mIsSubstituteView && Preferences.mPreviewViewSphereSize != 50)
