...
rem FOR /F "tokens=2"  %%i IN ('svn info -r HEAD ^| FINDSTR Revision:') DO SET REVISION_CMS=%%i
rem FOR /F "tokens=3*" %%i IN ('FINDSTR /c:"#define _BUILD_REVISION" build.h') DO SET REVISION_FILE=%%i
SET REVISION_CMS=999
