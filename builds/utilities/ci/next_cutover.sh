...
#   - COMMIT: Starting commit [Default=null]
#   - BRANCH: Working cutover development branch [Default=CUTOVER_NEXT]
#   - RELEASE: Create a release commit, preserve build tag, on the last commit [Default=null]
#   - CLONE: Clone a new instance of TO_REPO at the first commit [Default=null]
...
#   $ env FROM_REPO=lpub3dnext TO_REPO=lpub3d TAG=v2.4.0 BRANCH=CUTOVER_NEXT CLONE=1 RELEASE=1 COMMIT=9711c7147c973c ./next_cutover.sh
#
...
START_COMMIT=${COMMIT:-}
START_BRANCH=${BRANCH:-CUTOVER_NEXT}
