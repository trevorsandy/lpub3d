...
void CommonMenus::setWhatsThis()
{
    WT_Text WTData[] =
    {
        ...
        // WT_GUI_PART_ELEMENTS_BOM
        {
            ...
            "  Bill of material part element identifiers can<br>"
            "  be sourced from one of two files:<br>"
            "  - Bricklink Codes: codes.txt is the raw tab-delimited<br>"
            "    Bricklink file downloaded from<br>"
            "    https://www.bricklink.com/catalogDownload.asp<br>"
            "    %1 will automatically download a stored copy of<br>"
            "    this file if it is not found in the 'extras' folder.<br><br>"
            "  - User Defined Elements: legoelements.lst is a tab-delimited<br>"
            "    user-defined text file that should be placed in the<br>"
            "    %1 'extras' user data folder and include part id,<br>"
            "    color id and the LEGO element id (or whatever id you<br>"
            "    want to display) delimited by tabs.<br><br>"
            "  You can set %1 to use either LEGO element id or<br>"
            "  Bricklink id - a combination of the Bricklink part id<br>"
            "  and color id delimited with '-', for example 11145-87.<br><br>"
            "  The three options availale to display part element<br>"
            "  annotations are therefore:<br>"
            "  - Bricklink: use Bricklink part element identifier<br>"
            "    sourced from Bricklink codes.txt.<br><br>"
            "  - LEGO: use LEGO part element identifiers sourced<br>"
            "    from Bricklink codes.txt.<br><br>"
            "  - User Defined: use the part element identifier sourced from<br>"
            "    the legoelements.lst file.<br><br>"
            "  As with the other %1 configuration files, you can<br>"
            "  edit the local instance of these files to update<br>"
            "  add or remove part elements.%2<br>")
            .arg(QLatin1String(VER_PRODUCTNAME_STR))
            .arg(
#ifdef QT_DEBUG_MODE
