...
void CommonMenus::setWhatsThis()
{
    WT_Text WTData[] =
    {
        ...
        // WT_CONTROL_LPUB3D_PREFERENCES_FADE_STEPS
        {
            ...
            "    to select your desired global fade color.\n\n"
            "    When this option is not enabled, %1 faded parts\n"
            "    will display their assigned part color faded to the\n"
            "    specified opacity.\n\n"
        ...
        // WT_CONTROL_LPUB3D_PREFERENCES_GENERAL_SETTINGS
        {
            ...
            "  - Show load status: set %1 to display a load status\n"
        ...
        // WT_CONTROL_LPUB3D_PREFERENCES_VIEWPOINT_AND_PROJECTION
        {
            ...
            "    * Latitude/Loingitude: when set here, the camera\n"
            "      view will be set to 23 lat, 45 lon.\n"
        ...
        // WT_GUI_PART_ELEMENTS_BOM
        {
            ...
            "  - User Defined Elements: legoelements.lst is a tab-delimited\n"
            ...
            "  - User Defined: use the part element identifier sourced from\n"
        ...
        // WT_GUI_FADE_STEPS
        {
            ...
            "    However, you can manually enter any color using the\n"
            "    (#|0x)([AA]RRGGBB) hex [A]RGB value syntax.\n"
            "    Meta commands using LDraw colors will display the LDraw\n"
            "    color safe name (spaces replaced with '_') versus a\n"
            "    hex [A]RGB value as there are multiple LDraw colours\n"
