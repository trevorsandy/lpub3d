...
win32: stagewindistcontent {
    ...
    lpub3d_libs.files += \
        $$LPUB3D_STG_LIBS/LDrawIni161.dll \
        $$LPUB3D_STG_LIBS/QuaZIP07.dll
    ...
    contains (STG_ARCH, x86_64) {
        ...
        lpub3d_bins_qtlibs_x86_64.files += \
            ...
            $$[QT_INSTALL_BINS]\libicudt57.dll \
            $$[QT_INSTALL_BINS]\libicuin57.dll \
            $$[QT_INSTALL_BINS]\libicuuc57.dll \
    ...
    copy3rdcontent {
        ...
        ldview_stg_resources.path = $$LDVIEW_STG_RES_DIR\ini
