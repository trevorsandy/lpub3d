...
public:
  ...
  int getBuildModStep(const QString &modStepKey, const Where &here)
  {
      return ldrawFile.getBuildModStep(modStepKey, getSubmodelIndex(here.modelName), here.lineNumber);
  }
