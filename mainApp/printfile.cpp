...
void Gui::Print(QPrinter* Printer)
{
    ...
    QPageLayout::Orientation layoutOrientation = Printer->pageLayout().orientation();
    ...
    QPageLayout pageLayout(pageSize, layoutOrientation, QMarginsF(0,0,0,0),QPageLayout::Inch);
