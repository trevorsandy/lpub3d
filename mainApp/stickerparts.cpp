...
bool StickerParts::exportStickerParts(){
    ...
    if(file.open(QIODevice::WriteOnly | QIODevice::Text))
    {
        ...
        outstream << "# File: " << VER_STICKER_PARTS_FILE << endl;
        outstream << "# " << endl;
        outstream << "# This list captures sticker parts to support accurate part count." << endl;
        outstream << "# Sticker parts must be defined using the file name." << endl;
        outstream << "# " << endl;
        outstream << "# This file can be edited from LPub3D from:" << endl;
        outstream << "#    Configuration=>Edit Parameter Files=>Edit Part Count Sticker Parts List" << endl;
        outstream << "#" << endl;
        ...
        outstream << "#" << endl;
        outstream << "# The generated list is a truncated set from the official and unofficial LDraw parts archive." << endl;
        outstream << "#" << endl;
