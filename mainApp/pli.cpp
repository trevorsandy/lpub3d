...
//                                         .arg(step ? step->calledOut ? step->topOfCallout().lineNumber : step->multiStep ? step->topOfSteps().lineNumber : step->topOfStep().lineNumber : 0));
        ...
        if (! gui->exportingObjects() && pT == NORMAL_PART) {
            ...
            viewerOptions->Position       = xyzVector(pliMeta.position.x(),pliMeta.position.y(),pliMeta.position.z());
            ...
            viewerOptions->UpVector       = xyzVector(pliMeta.upvector.x(),pliMeta.upvector.y(),pliMeta.upvector.z());
