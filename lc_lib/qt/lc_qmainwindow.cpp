...
void lcQMainWindow::createActions()
{
	...
	actions[LC_FILE_NEW]->setIcon(QIcon(":/lc_lib/resources/file_new.png"));
	actions[LC_FILE_OPEN]->setIcon(QIcon(":/lc_lib/resources/file_open.png"));
	actions[LC_FILE_SAVE]->setIcon(QIcon(":/lc_lib/resources/file_save.png"));
	actions[LC_FILE_SAVE_IMAGE]->setIcon(QIcon(":/lc_lib/resources/file_picture.png"));
	actions[LC_FILE_PRINT]->setIcon(QIcon(":/lc_lib/resources/file_print.png"));
	actions[LC_FILE_PRINT_PREVIEW]->setIcon(QIcon(":/lc_lib/resources/file_print_preview.png"));
	actions[LC_EDIT_UNDO]->setIcon(QIcon(":/lc_lib/resources/edit_undo.png"));
	actions[LC_EDIT_REDO]->setIcon(QIcon(":/lc_lib/resources/edit_redo.png"));
	actions[LC_EDIT_CUT]->setIcon(QIcon(":/lc_lib/resources/edit_cut.png"));
	actions[LC_EDIT_COPY]->setIcon(QIcon(":/lc_lib/resources/edit_copy.png"));
	actions[LC_EDIT_PASTE]->setIcon(QIcon(":/lc_lib/resources/edit_paste.png"));
	actions[LC_EDIT_ACTION_INSERT]->setIcon(QIcon(":/lc_lib/resources/action_insert.png"));
	actions[LC_EDIT_ACTION_LIGHT]->setIcon(QIcon(":/lc_lib/resources/action_light.png"));
	actions[LC_EDIT_ACTION_SPOTLIGHT]->setIcon(QIcon(":/lc_lib/resources/action_spotlight.png"));
	actions[LC_EDIT_ACTION_CAMERA]->setIcon(QIcon(":/lc_lib/resources/action_camera.png"));
	actions[LC_EDIT_ACTION_SELECT]->setIcon(QIcon(":/lc_lib/resources/action_select.png"));
	actions[LC_EDIT_ACTION_MOVE]->setIcon(QIcon(":/lc_lib/resources/action_move.png"));
	actions[LC_EDIT_ACTION_ROTATE]->setIcon(QIcon(":/lc_lib/resources/action_rotate.png"));
	actions[LC_EDIT_ACTION_DELETE]->setIcon(QIcon(":/lc_lib/resources/action_delete.png"));
	actions[LC_EDIT_ACTION_PAINT]->setIcon(QIcon(":/lc_lib/resources/action_paint.png"));
	actions[LC_EDIT_ACTION_ZOOM]->setIcon(QIcon(":/lc_lib/resources/action_zoom.png"));
	actions[LC_EDIT_ACTION_PAN]->setIcon(QIcon(":/lc_lib/resources/action_pan.png"));
	...
	actions[LC_VIEW_SPLIT_VERTICAL]->setIcon(QIcon(":/lc_lib/resources/view_split_vertical.png"));
	actions[LC_VIEW_ZOOM_IN]->setIcon(QIcon(":/lc_lib/resources/view_zoomin.png"));
	actions[LC_VIEW_ZOOM_OUT]->setIcon(QIcon(":/lc_lib/resources/view_zoomout.png"));
	actions[LC_VIEW_ZOOM_EXTENTS]->setIcon(QIcon(":/lc_lib/resources/view_zoomextents.png"));
	actions[LC_VIEW_TIME_FIRST]->setIcon(QIcon(":/lc_lib/resources/time_first.png"));
	actions[LC_VIEW_TIME_PREVIOUS]->setIcon(QIcon(":/lc_lib/resources/time_previous.png"));
	actions[LC_VIEW_TIME_NEXT]->setIcon(QIcon(":/lc_lib/resources/time_next.png"));
	actions[LC_VIEW_TIME_LAST]->setIcon(QIcon(":/lc_lib/resources/time_last.png"));
	actions[LC_VIEW_TIME_ADD_KEYS]->setIcon(QIcon(":/lc_lib/resources/time_add_keys.png"));
	actions[LC_HELP_HOMEPAGE]->setIcon(QIcon(":/lc_lib/resources/help_homepage.png"));
	actions[LC_HELP_EMAIL]->setIcon(QIcon(":/lc_lib/resources/help_email.png"));
