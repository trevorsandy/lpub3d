	...
	ui(new Ui::lcQAboutDialog)
{
    ...
    ui->version->setText(tr("LeoCAD Version %1 - Build %2")
                         .arg(QString::fromLatin1(LC_VERSION_TEXT))
    ...
    QString Anisotropic = GL_SupportsAnisotropic ? tr("Supported (max %1)").arg(QString::number(GL_MaxAnisotropy)) : tr("Not supported");
