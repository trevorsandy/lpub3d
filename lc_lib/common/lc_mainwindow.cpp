...
void lcMainWindow::CreateToolBars()
{
    ...
    mStandardToolBar->removeAction(mActions[LC_FILE_PRINT]);
    mStandardToolBar->removeAction(mActions[LC_FILE_PRINT_PREVIEW]);
    mStandardToolBar->removeAction(mActions[LC_EDIT_UNDO]);
    mStandardToolBar->removeAction(mActions[LC_EDIT_REDO]);
    mStandardToolBar->removeAction(mActions[LC_EDIT_CUT]);
    mStandardToolBar->removeAction(mActions[LC_EDIT_COPY]);
    mStandardToolBar->removeAction(mActions[LC_EDIT_PASTE]);
    mStandardToolBar->removeAction(LockAction);
    mStandardToolBar->removeAction(MoveAction);
    mStandardToolBar->removeAction(AngleAction);
    mStandardToolBar->removeAction(mActions[LC_EDIT_TRANSFORM]);

    QAction* WidgetAction = mStandardToolBar->addWidget(TransformWidget);
    WidgetAction->setVisible(false);

    // remove unneeded separators
    foreach(QAction* tbAction, mStandardToolBar->actions())
    {
        if (tbAction->isSeparator())
            mStandardToolBar->removeAction(tbAction);
    }
