...
- Get the hash file [LPub3D-2.4.7.53.3529_20230820.exe.sha512](https://github.com/trevorsandy/lpub3d/releases/download/continuous/LPub3D-2.4.7.53.3529_20230820.exe.sha512)
- Open a PowerShell session
- Add the package download path to `$PkgUrl`
- Add the hash file sha512 hash to `$PublishedHash`.
```
$WebClient = [System.Net.WebClient]::new()
$PkgUrl = 'https://github.com/trevorsandy/lpub3d/releases/download/continuous/LPub3D-2.4.7.53.3529_20230820.exe'
$PublishedHash = '12ba38870e26b6fe7057740c0bfcb45055d31953e6c5e18e546869e2e7bfb5ace93f61f417847afd14226e4d76d966bf038ca417320dcea7546d0778f43ade3a'
...
- Get the release: [LPub3D-2.4.7.53.3529_20230820-x86_64.AppImage](https://github.com/trevorsandy/lpub3d/releases/download/continuous/LPub3D-2.4.7.53.3529_20230820-x86_64.AppImage)
- Get the hash file: [LPub3D-2.4.7.53.3529_20230820-x86_64.AppImage.sha512](https://github.com/trevorsandy/lpub3d/releases/download/continuous/LPub3D-2.4.7.53.3529_20230820-x86_64.AppImage.sha512)
- Get the GPG hash file signature: [LPub3D-2.4.7.53.3529_20230820-x86_64.AppImage.sha512.sig](https://github.com/trevorsandy/lpub3d/releases/download/continuous/LPub3D-2.4.7.53.3529_20230820-x86_64.AppImage.sha512.sig)
- Ensure GPG is installed and configured: `$> which gpg`
- Import the public key file into GPG: `$> gpg --import pubring.auto`
- Verify the against its hash file: `$> sha512sum -c LPub3D-2.4.7.53.3529_20230820-x86_64.AppImage.sha512`
- Verify the GPG hash file signature: `$> gpg --verify LPub3D-2.4.7.53.3529_20230820-x86_64.AppImage.sha512.sig`
...
[windows-url]:         https://github.com/trevorsandy/lpub3d/releases/download/continuous/LPub3D-2.4.7.53.3529_20230820.exe
[macos-url]:           https://github.com/trevorsandy/lpub3d/releases/download/continuous/LPub3D-2.4.7.53.3529_20230820-macos.dmg
[appimage-url]:        https://github.com/trevorsandy/lpub3d/releases/download/continuous/LPub3D-2.4.7.53.3529_20230820-x86_64.AppImage
...
[gh-rel-url]:          https://github.com/trevorsandy/lpub3d/releases/latest "LPub3D-2.4.7.53.3529_20230820"
...
[gh-maintained-url]:   https://github.com/trevorsandy/lpub3d/projects/1 "Last edited 20-08-2023"
